...
public class WSFrame {
	...
	public WSFrame() {
		frame = new JFrame("达巴赖马微博分析平台");
		frame.getContentPane().setBackground(new Color(249, 137, 3));
	...
	private JTabbedPane createNavigationPanel() { // 创建导航标签面板的方法
		...
		tabbedPane.setBackground(new Color(253, 232, 161));
		tabbedPane.setBorder(new BevelBorder(BevelBorder.RAISED));

		JPanel baseManagePanel = new JPanel(); // 公共分析面板
		baseManagePanel.setBackground(new Color(253, 232, 161));
		baseManagePanel.setLayout(new BoxLayout(baseManagePanel,BoxLayout.X_AXIS));
		baseManagePanel.add(createFrameButton("微博分析", "Weiboanalysis"));
		baseManagePanel.add(createFrameButton("粉丝分析", "Fananalysis"));
		baseManagePanel.add(createFrameButton("微博监控", "Weibomonitor"));

		JPanel depotManagePanel = new JPanel(); // 个人管理面板
		depotManagePanel.setBackground(new Color(253, 232, 161));
		depotManagePanel.setLayout(new BoxLayout(depotManagePanel,
				BoxLayout.X_AXIS));
		depotManagePanel.add(createFrameButton("互粉管理", "Fansmanagement"));
		...
		tabbedPane.addTab("   公共分析   ", null, baseManagePanel, "公共分析");
		//tabbedPane.addTab("   你妹   ", null, stockManagePanel, "进货管理");
		//tabbedPane.addTab("   碉堡了   ", null, sellManagePanel, "销售管理");
		//tabbedPane.addTab("   坑跌啊   ", null, searchStatisticPanel, "查询统计");
		tabbedPane.addTab("   个人管理   ", null, depotManagePanel, "个人管理");
		//tabbedPane.addTab("   蛋疼菊紧   ", null, sysManagePanel, "系统管理");
