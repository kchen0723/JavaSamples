...
public class ChangeCode {  
	...
	//Ö´ÐÐ  ±äÁ¿flag  ÊÇÀ´ÅÐ¶Ï½øÐÐ ÄÄÖÖÐÎÊ½µÄ×ª»»  
	 ...
	 //	   ChangeCode jf = new ChangeCode(); 
	 //   System.out.println(jf.toShort("Ë®½È")); 
	 //} 
}
